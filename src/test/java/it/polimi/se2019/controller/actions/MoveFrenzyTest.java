...
public class MoveFrenzyTest {
    ...
    public void setUp() throws Exception {
        ...
        action = new MoveFrenzy(gameHandler, controller);
        ...
        commonCell = gameHandler.getCellByCoordinate(0,2);
    ...
    public void correctMovement() {
        ...
        assertEquals(3, authorPlayer.getCell().getCoordinateX());
