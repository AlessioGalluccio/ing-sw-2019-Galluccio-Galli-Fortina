...
public class FlameThrower_1Test {
    ...
    public void firePositiveNoTargetingSelectingAdjacentCell() throws Exception {
        ...
        assertEquals(FlameThrower_1.SELECT_FIRST_TARGET, playerView.getLastStringPrinted());
        ...
        assertEquals(FlameThrower_1.SELECT_SECOND_TARGET, playerView.getLastStringPrinted());
