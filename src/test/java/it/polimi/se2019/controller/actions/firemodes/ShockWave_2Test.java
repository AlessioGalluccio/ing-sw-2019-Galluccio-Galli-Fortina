...
public class ShockWave_2Test {
    ...
    public void setUp() throws Exception {
        ...
        targetPlayer3.setPosition(gameHandler.getCellByCoordinate(1,0));    //in same cell of target 2
    ...
    public void firePositiveNoTargeting() throws Exception {
        ...
        assertEquals(1,targetPlayer3.getDamage().size());   //he must be hitten, unlike the base firemode
